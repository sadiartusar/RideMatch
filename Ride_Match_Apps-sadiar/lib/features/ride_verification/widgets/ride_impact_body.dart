...
/// Embedded Ride Impact body for the Driver Home Shell.
class RideImpactBody extends StatelessWidget {
  const RideImpactBody({
    super.key,
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildShareIcon(
                          Icons.share_rounded,
                          () => controller.shareImpact('General'),
                          cardBg,
                          borderCol,
                          textColor),
                      ...
                      _buildShareIcon(
                          ...
                          () => controller.shareImpact('Instagram'),
                          cardBg,
                          borderCol,
                          textColor),
                      const SizedBox(width: 12),
                      _buildShareIcon(
                          ...
                          () => controller.shareImpact('Facebook'),
                          cardBg,
                          borderCol,
                          textColor),
                    ],
