...
import 'verify_pin_tab.dart';
import 'verify_qr_tab.dart';

/// Embedded Ride Verify body for the Driver Home Shell.
class RideVerifyBody extends StatelessWidget {
  const RideVerifyBody({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final scaffoldBg =
        isDark ? const Color(0xFF0D0F11) : const Color(0xFFF9FAFB);
