              ...
              children: [
                ...
                Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      Icon(Icons.check_circle_rounded, color: greenAccent, size: 14),
                      SizedBox(width: 5),
                      Text(
                        'RIDE VERIFIED',
                        style: TextStyle(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            _buildStatColumn('Time', '12 min', textColor, isDark),
                            _buildStatDivider(borderCol),
                            _buildStatColumn('Distance', '${controller.rideData.sharedKm.toStringAsFixed(1)} km', textColor, isDark),
                            _buildStatDivider(borderCol),
                            _buildStatColumn('Match', '94%', greenAccent, isDark),
                          ],
                        ),
                      ),
                    ],
                      ...
                      return GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: Icon(
                            ...
                            color: isSelected ? const Color(0xFFFBBF24) : (isDark ? const Color(0xFF4B5563) : const Color(0xFFD1D5DB)),
                            size: 38,
                          ),
                        ),
                      );
                    ...
                    children: controller.availableTags.map((tag) {
                      ...
                      return FilterChip(
                        ...
                        labelStyle: TextStyle(
                          color: isTagSelected ? (isDark ? Colors.white : Colors.black) : (isDark ? const Color(0xFF9CA3AF) : const Color(0xFF4B5563)),
                          fontSize: 12,
                          fontWeight: isTagSelected ? FontWeight.w700 : FontWeight.w500,
                        ),
