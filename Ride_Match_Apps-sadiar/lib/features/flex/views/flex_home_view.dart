...
import '../../rider/widgets/rider_commute_circles_grid.dart';
import '../../rider/widgets/rider_destination_card.dart';
import '../../rider/widgets/rider_earn_coupons_card.dart';
import '../../rider/widgets/rider_mode_pill_selector.dart';
import '../../rider/widgets/rider_quote_card.dart';
import '../../rider/widgets/rider_safety_card.dart';
import '../../rider/widgets/rider_social_trust_card.dart';
import '../../rider/widgets/rider_top_bar.dart';
import '../../rider/widgets/rider_verification_card.dart';
import '../../rider/widgets/rider_welcome_offer_card.dart';
import '../controllers/flex_home_controller.dart';

class FlexHomeView extends GetView<FlexHomeController> {
  const FlexHomeView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return const FlexWalletView();
  }
            return _FlexHomeContent(controller: controller);
          }),
        ),
...
class _FlexHomeContent extends StatelessWidget {
  const _FlexHomeContent({required this.controller});

  final FlexHomeController controller;
