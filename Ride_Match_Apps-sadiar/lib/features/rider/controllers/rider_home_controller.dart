...
class RiderHomeController extends GetxController {
  RiderHomeController({ModeService? modeService})
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Use starter coupons and reward discounts for matched commutes.',
  ...
  void onSocialTapped(String platform) {
    Get.snackbar(
      '$platform Connected',
      'Your $platform account is linked to your rider profile.',
