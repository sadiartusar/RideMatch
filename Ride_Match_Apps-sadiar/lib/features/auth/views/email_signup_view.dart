...
/// Email signup — new user email + password.
...
class _EmailSignupViewState extends State<EmailSignupView> {
  ...
  void _continue() {
    ...
    if (_passwordController.text.isEmpty || _confirmController.text.isEmpty) {
      Get.snackbar('Password Required', 'Please enter and confirm your password.');
      return;
    }
    ...
    Get.toNamed(
      AppRoutes.otp,
      arguments: OtpArgs(destination: email, isNewUser: true),
    );
  }
